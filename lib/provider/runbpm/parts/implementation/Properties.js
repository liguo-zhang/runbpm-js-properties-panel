...
/**
 * Get all runbpm:property objects for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {Array<ModdleElement>} a list of runbpm:property objects
 */
...
/**
 * Get all runbpm:Properties object for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {ModdleElement} a runbpm:Properties object
 */
...
/**
 * Get first runbpm:Properties object for a specific bpmn:ExtensionElements
 * business object.
 *
...
function getPropertiesElementInsideExtensionElements(extensionElements) {
  return find(extensionElements.values, function(elem) {
    return is(elem, 'runbpm:Properties');
  });
}
...
/**
 * Create a runbpm:property entry using tableEntryFactory
 *
...
module.exports = function(element, bpmnFactory, options) {
  ...
  assign(options, {
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('runbpm:Properties', {}, parent, bpmnFactory);
      ...
      var property = elementHelper.createElement('runbpm:Property', propertyProps, properties, bpmnFactory);
    ...
    removeElement: function(element, node, idx) {
      ...
      if (propertyValues.length === 1) {
        // remove runbpm:properties if the last existing property has been removed
        if (!isExtensionElements(parent)) {
